...
const Navbar = () => {
    ...
    return (
        <div className="poppins relative z-50">
            ...
            <div
                className={`fixed top-0 right-0 h-screen w-2/3 bg-gray-900 text-white border-l border-gray-700 transform ${isOpen ? "translate-x-0" : "translate-x-full"
        ...
        {/* // Mobile Resume Button */}
                <Link
                    to="/resume" // তোমার Resume page route
