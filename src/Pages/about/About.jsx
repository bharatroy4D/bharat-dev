  ...
  return (
    <div className="bg-slate-900 text-white min-h-screen py-16 px-8 relative overflow-hidden rounded-2xl border border-orange-500">
      ...
      <motion.div
        ...
        animate="show"
      >
        <motion.h1 variants={item} className="text-4xl lg:text-5xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 mb-4">
          About Me
        </motion.h1>
