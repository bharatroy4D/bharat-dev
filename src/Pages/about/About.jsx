...
const About = () => {
  ...
  return (
    <div id="about" className="bg-slate-800 text-white min-h-screen rounded-2xl border border-orange-500 py-10 lg:py-20 px-6 lg:px-16 relative overflow-hidden">
